var Layout, conf, get, open, _ref;

require('../_prepare');

_ref = (function() {
  var c, defaultBlockConfig, object, ret, show;
  object = require('utila').object;
  show = function(layout) {
    var got;
    got = layout.get();
    got = got.replace(/<[^>]+>/g, '');
    return console.log('got:', got);
  };
  defaultBlockConfig = {
    linePrependor: {
      options: {
  ...
  return ret;
})(), open = _ref.open, get = _ref.get, conf = _ref.conf;
...
it("should not put extra line breaks when a line is already broken", function() {
  var block, l;
  l = new Layout;
  block = l.openBlock(conf({
    width: 20
...
it("should break lines according to terminal width", function() {
  var block, l;
  l = new Layout({
    terminalWidth: 20
  });
...
test("margin top should work for: line, block", function() {
  var l;
  l = new Layout;
  l.write('a');
  l.openBlock(conf({
...
test("margin top should work for: block, line", function() {
  var l;
  l = new Layout;
  l.openBlock(conf({
    top: 1
...
test("margin top should work for: block, line, when block starts with a break", function() {
  var l;
  l = new Layout;
  l.openBlock(conf({
    top: 1
...
test("margin top should work for: line, block, when line ends with a break", function() {
  var l;
  l = new Layout;
  l.write('a\n');
  l.openBlock(conf({
...
test("margin top should work for: line, block, when there are two breaks in between", function() {
  var l;
  l = new Layout;
  l.write('a\n');
  l.openBlock(conf({
...
test("margin bottom should work for: line, block", function() {
  var l;
  l = new Layout;
  l.write('a');
  debugger;
...
test("margin bottom should work for: block, line", function() {
  var l;
  l = new Layout;
  l.openBlock(conf({
    bottom: 1
...
test("margin bottom should work for: block, line, when block ends with a break", function() {
  var l;
  l = new Layout;
  l.openBlock(conf({
    bottom: 1
...
test("margin bottom should work for: block, line, when line starts with a break", function() {
  var l;
  l = new Layout;
  l.openBlock(conf({
    bottom: 1
...
test("margin bottom should work for: block, line, when there are two breaks in between", function() {
  var l;
  l = new Layout;
  l.openBlock(conf({
    bottom: 1
...
test("a(top: 0, bottom: 0) b(top: 0, bottom: 0)", function() {
  var l;
  l = new Layout;
  l.openBlock().write('a').close();
  l.openBlock().write('b').close();
...
test("a(top: 0, bottom: 0) b(top: 1, bottom: 0)", function() {
  var l;
  l = new Layout;
  l.openBlock().write('a').close();
  l.openBlock(conf({
...
test("a(top: 0, bottom: 1) b(top: 0, bottom: 0)", function() {
  var l;
  l = new Layout;
  l.openBlock(conf({
    bottom: 1
...
test("a(top: 0, bottom: 1   ) b(   top: 1, bottom: 0)", function() {
  var l;
  l = new Layout;
  l.openBlock(conf({
    bottom: 1
...
test("a(top: 0, bottom: 1 br) b(br top: 1, bottom: 0)", function() {
  var l;
  l = new Layout;
  l.openBlock(conf({
    bottom: 1
...
test("a(top: 2, bottom: 3 a1-br-a2) b(br-b1-br-br-b2-br top: 2, bottom: 3)", function() {
  var l;
  l = new Layout;
  l.openBlock(conf({
    top: 2,
...
test("a(left: 2) > b(top: 2)", function() {
  var a, l;
  l = new Layout;
  a = l.openBlock(conf({
    left: 2
...
test("a(left: 2) > b(bottom: 2)", function() {
  var a, l;
  l = new Layout;
  a = l.openBlock(conf({
    left: 2
...
test("a(left: 3, bullet) > b(top:1)", function() {
  var a, b, l;
  l = new Layout;
  a = l.openBlock(conf({
    left: 3,

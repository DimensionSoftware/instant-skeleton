var Block, SpecialString, blockConfig;
...
module.exports = Block = (function() {
  ...
  function Block(_layout, _parent, config, _name) {
    ...
    this._config = blockConfig(config, self.defaultConfig);
    this._closed = false;
  ...
  Block.prototype._writeInline = function(str) {
    var i, lineBreaksToAppend, m, remaining, _i, _j, _k, _ref, _ref1;
    ...
    if (m = remaining.match(/^\n+/)) {
      for (i = _i = 1, _ref = m[0].length; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
        this._writeLine('');
      }
    ...
    while (remaining.length > 0) {
      if (m = remaining.match(/^[^\n]+/)) {
        ...
        for (i = _j = 1, _ref1 = m[0].length; 1 <= _ref1 ? _j < _ref1 : _j > _ref1; i = 1 <= _ref1 ? ++_j : --_j) {
          this._writeLine('');
        }
        remaining = remaining.substr(m[0].length, remaining.length);
      }
    ...
    if (lineBreaksToAppend > 0) {
      for (i = _k = 1; 1 <= lineBreaksToAppend ? _k <= lineBreaksToAppend : _k >= lineBreaksToAppend; i = 1 <= lineBreaksToAppend ? ++_k : --_k) {
        this._writeLine('');
      }
    }
  };

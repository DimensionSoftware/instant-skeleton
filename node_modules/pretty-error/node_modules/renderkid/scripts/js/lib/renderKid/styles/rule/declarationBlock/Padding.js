var Padding, PaddingBottom, PaddingLeft, PaddingRight, PaddingTop, _Declaration, _ref,
...
module.exports = Padding = (function(_super) {
  var self;

  __extends(Padding, _super);

  function Padding() {
    _ref = Padding.__super__.constructor.apply(this, arguments);
    return _ref;
  }

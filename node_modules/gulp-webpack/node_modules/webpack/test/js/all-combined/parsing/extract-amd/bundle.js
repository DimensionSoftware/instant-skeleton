...
function(e,t,r){/*!
	 ...
	 * MIT Licensed
	 */
var n=r(/*! ../util */1),o=r(/*! assert */9),i=o.AssertionError;e.exports=function(e){var t=e.format;n.merge(e,o),e.exist=e.exists=function(r,n){if(null==r)throw new i({message:n||"expected "+t(r)+" to exist",stackStartFunction:e.exist})},e.not={},e.not.exist=e.not.exists=function(r,n){if(null!=r)throw new i({message:n||"expected "+t(r)+" to not exist",stackStartFunction:e.not.exist})}}},/*!******************************************!*\
...
function(e){/*!
	 ...
	 * MIT Licensed
	 */
e.exports=function(e,t){t.add("true",function(){this.is.exactly(!0)},!0),t.alias("true","True"),t.add("false",function(){this.is.exactly(!1)},!0),t.alias("false","False"),t.add("ok",function(){this.params={operator:"to be truthy"},this.assert(this.obj)},!0)}},/*!*******************************************!*\
...
function(e){/*!
	 ...
	 * MIT Licensed
	 */
e.exports=function(e,t){function r(e){Object.defineProperty(t.prototype,e,{get:function(){return this},enumerable:!0})}["an","of","a","and","be","have","with","is","which","the"].forEach(r)}},/*!*********************************************!*\
...
function(e,t,r){/*!
	 ...
	 * MIT Licensed
	 */
var n=r(/*! ../eql */5);e.exports=function(e,t){t.add("eql",function(e,t){this.params={operator:"to equal",expected:e,showDiff:!0,message:t},this.assert(n(e,this.obj))}),t.add("equal",function(e,t){this.params={operator:"to be",expected:e,showDiff:!0,message:t},this.assert(e===this.obj)}),t.alias("equal","exactly")}},/*!*******************************************!*\
...
function(e){/*!
	 ...
	 * MIT Licensed
	 */
e.exports=function(e,t){t.add("startWith",function(t,r){this.params={operator:"to start with "+e.format(t),message:r},this.assert(0===this.obj.indexOf(t))}),t.add("endWith",function(t,r){this.params={operator:"to end with "+e.format(t),message:r},this.assert(this.obj.indexOf(t,this.obj.length-t.length)>=0)})}},/*!******************************************!*\

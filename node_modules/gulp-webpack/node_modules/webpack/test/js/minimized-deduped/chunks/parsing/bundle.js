!function(t){function e(n){if(r[n])return r[n].exports;var o=r[n]={exports:{},id:n,loaded:!1};return t[n].call(o.exports,o,o.exports,e),o.loaded=!0,o.exports}var r={},n={0:1};return e.e=function(r,o){if(1===n[r])o.call(null,e);else if(n[r])n[r].push(o);else{n[r]=[o];var i=__dirname+"/"+r+".bundle.js";require("fs").readFile(i,"utf-8",function(r,o){if(r){if(e.onError)return e.onError(r);throw r}var s={};require("vm").runInThisContext("(function(exports, require, __dirname, __filename) {"+o+"\n})",i)(s,require,require("path").dirname(i),i);var a=s.modules,u=s.ids;for(var c in a){var l=a[c];switch(typeof l){case"number":t[c]=t[l];break;case"object":t[c]=function(e){var r=e.slice(1),n=e[0];return function(e,o,i){t[n].apply(this,[e,o,i].concat(r))}}(l);break;default:t[c]=l}}for(var f=[],p=0;p<u.length;p++)Array.isArray(n[u[p]])&&(f=f.concat(n[u[p]])),n[u[p]]=1;for(p=0;p<f.length;p++)f[p].call(null,e)})}},e.m=t,e.c=r,e.p="",e(0)}(function(t){for(var e in t)switch(typeof t[e]){case"number":t[e]=t[t[e]];break;case"object":t[e]=function(e){var r=e.slice(1),n=t[e[0]];return function(t,e,o){n.apply(null,[t,e,o].concat(r))}}(t[e])}return t}([/*!*********************************!*\
  ...
  \*********************************/
function(t,e,r){var n=r(/*! should */4);it("should handle bound function expressions",function(t){r.e(1,function(){this.should.be.eql({test:!0}),r(/*! ./empty?test */2),process.nextTick.should.have.type("function"),!function(){this.should.be.eql({test:!0}),t()}.bind(this)(r)}.bind({test:!0}))}),it("should handle require.ensure without function expression",function(t){function e(){t()}!e(r)}),it("should parse expression in require.ensure, which isn't a function expression",function(t){!function(){/*! ./empty?require.ensure:test */
return r(1).should.be.eql({}),function(){t()}}()(r)}),it("should accept a require.include call",function(){var t=null;!function(){t=r(/*! ./require.include */3)}(r),n.strictEqual(t,"require.include"),t.should.be.eql("require.include")})},/*!*****************************************************!*\

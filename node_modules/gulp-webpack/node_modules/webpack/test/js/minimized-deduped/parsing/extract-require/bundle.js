!function(t){function e(n){if(r[n])return r[n].exports;var o=r[n]={exports:{},id:n,loaded:!1};return t[n].call(o.exports,o,o.exports,e),o.loaded=!0,o.exports}var r={};return e.m=t,e.c=r,e.p="",e(0)}([/*!******************************************!*\
  ...
  \******************************************/
function(t,e,r){function n(t){r(1===t?/*! ./folder/file1 */2:2===t?/*! ./folder/file2 */3:3===t?/*! ./folder/file3 */4:!function(){var t=new Error('Cannot find module "./missingModule"');throw t.code="MODULE_NOT_FOUND",t}()).should.be.eql("file"+t),r(1===t?/*! ./folder/file1 */2:2===t?/*! ./folder/file2 */3:3===t?/*! ./folder/file3 */4:!function(){var t=new Error('Cannot find module "./missingModule"');throw t.code="MODULE_NOT_FOUND",t}()).should.be.eql("file"+t)}var o=r(/*! should */5);it("should parse complex require calls",function(){o.strictEqual(new(r(/*! ./constructor */1))(1234).value,1234,"Parse require in new(...) should work"),o.strictEqual(new(r(/*! ./constructor */1))(1234).value,1234,"Parse require in new(...) should work, with spaces")}),it("should let the user hide the require function",function(){function t(t,e){return e}(function(t){return t})(1234).should.be.eql(1234),t(333,678).should.be.eql(678),function(){var t=123;t.should.be.eql(123)}(),function(){function t(){return 123}t("error").should.be.eql(123)}(),function(){var t=1233;t.should.be.eql(1233)}()}),it("should not create a context for the ?: operator",function(){n(1),n(2),n(3)})},/*!************************************************!*\
...
function(t){t.exports=function(t){this.value=t}},/*!*************************************************!*\
  ...
  \*************************************************/
function(t){t.exports="file1"},/*!*************************************************!*\
  !*** ./parsing/extract-require/folder/file2.js ***!
  \*************************************************/
function(t){t.exports="file2"},/*!*************************************************!*\
  !*** ./parsing/extract-require/folder/file3.js ***!
  \*************************************************/
function(t){t.exports="file3"},/*!****************************************!*\
...
function(t,e,r){/*!
	 ...
	 * MIT Licensed
	 */
var n=r(/*! ../eql */20);t.exports=function(t,e){e.add("eql",function(t,e){this.params={operator:"to equal",expected:t,showDiff:!0,message:e},this.assert(n(t,this.obj))}),e.add("equal",function(t,e){this.params={operator:"to be",expected:t,showDiff:!0,message:e},this.assert(t===this.obj)}),e.alias("equal","exactly")}},/*!******************************************!*\
...
function(t,e,r){function n(t,e){if(t===e)return!0;if(i.isBuffer(t)&&i.isBuffer(e)){if(t.length!=e.length)return!1;for(var r=0;r<t.length;r++)if(t[r]!==e[r])return!1;return!0}return i.isDate(t)&&i.isDate(e)?t.getTime()===e.getTime():i.isRegExp(t)&&i.isRegExp(e)?t.source===e.source&&t.global===e.global&&t.multiline===e.multiline&&t.lastIndex===e.lastIndex&&t.ignoreCase===e.ignoreCase:i.isObject(t)||i.isObject(e)?o(t,e):t==e}function o(t,e){if(i.isNullOrUndefined(t)||i.isNullOrUndefined(e))return!1;if(t.prototype!==e.prototype)return!1;if(i.isArguments(t))return i.isArguments(e)?(t=s.call(t),e=s.call(e),n(t,e)):!1;try{var r,o,a=Object.keys(t),u=Object.keys(e)}catch(c){return!1}if(a.length!=u.length)return!1;for(a.sort(),u.sort(),o=a.length-1;o>=0;o--)if(a[o]!=u[o])return!1;for(o=a.length-1;o>=0;o--)if(r=a[o],!n(t[r],e[r]))return!1;return!0}/*!
	 ...
	 * MIT Licensed
	 */
var i=r(/*! ./util */6);t.exports=n;var s=Array.prototype.slice}]);